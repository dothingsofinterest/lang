...
import { Layout, List, Input, Space, Button, Upload, Checkbox, Divider, Col, Row, Tree  } from "antd";
import "./Video.scss";
    ...
    const treeData = [
        {
            ...
            key: "0",
            children: [
                { title: "0-0-2", key: "0-0-2", "startTime": "00:00:55,442", },
        ...
        },
        {
            title: "P1",
            key: "1",
            children: [{ title: "1-0-1", key: "1-0-1" }],
        },
        {
            title: "P2",
            key: "2",
            children: [{ title: "2-0-1", key: "2-0-1" }],
        },
    ];
...
<Tree treeData={treeData} defaultExpandAll titleRender={(item) => {
