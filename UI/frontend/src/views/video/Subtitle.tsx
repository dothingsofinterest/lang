...
const Subtitle = () => {
    console.log("----------Render | Video/ClipMaterial----------");
    ...
    const handlersUpdateScriptAss = (key: string, value: number | string | null) => {
        console.log(refPreview.current?.naturalWidth);
        if (key && value) {
                ...
                <aside id="asider" style={{ width: "100%", height: "100%", boxSizing: "border-box", backgroundColor: "#202024" }}>
                    <section id="asider" style={{ width: "100%", height: "32px", backgroundColor: "#202024" }}>
                        <div style={{ width: "100%", display: "flex", justifyContent: "space-between" }}>
                            <Button icon={<CloudUploadOutlined />} onClick={handlersPreview} loading={processings[2]} disabled={processings[2]} style={{ flex: 1, borderRadius: "0", backgroundColor: "#ccc" }}>
                                Preview
                            </Button>
                            <Button icon={<CloudUploadOutlined />} onClick={handlersClipSubtitleVideo} loading={processings[1]} disabled={processings[1]} style={{ flex: 1, borderRadius: "0", backgroundColor: "#ccc" }}>
                                Generating a subtitle video.
                            </Button>
                        </div>
                        <div style={{ width: "100%", backgroundColor: "#ccc", display: "flex", justifyContent: "space-between" }}>
                            <div style={{ flex: 1, display: "flex", alignItems: "center", justifyContent: "center" }}>CN</div>
                            ...
                            />
                            <InputNumber style={{ flex: "0 0 140px" }} addonBefore="MarginLR: " min={0} max={100} step={1} value={script.assFormat.cnMarginLR} onChange={(v) => handlersUpdateScriptAss("cnMarginLR", v)} />
                            <InputNumber style={{ flex: "0 0 140px" }} addonBefore="MarginV: " min={0} max={300} step={1} value={script.assFormat.cnMarginV} onChange={(v) => handlersUpdateScriptAss("cnMarginV", v)} />
                        </div>
                        <div style={{ width: "100%", backgroundColor: "#ccc", display: "flex", justifyContent: "space-between" }}>
                            <div style={{ flex: 1, display: "flex", alignItems: "center", justifyContent: "center" }}>EN </div>
                            ...
                            />
                            <InputNumber style={{ flex: "0 0 140px" }} addonBefore="MarginLR: " min={0} max={100} step={1} value={script.assFormat.enMarginLR} onChange={(v) => handlersUpdateScriptAss("enMarginLR", v)} />
                            <InputNumber style={{ flex: "0 0 140px" }} addonBefore="MarginV: " min={0} max={300} step={1} value={script.assFormat.enMarginV} onChange={(v) => handlersUpdateScriptAss("enMarginV", v)} />
                        </div>
                        <div style={{ width: "100%", display: "flex", justifyContent: "space-between" }}>
